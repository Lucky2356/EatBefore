...
> **Статус:** milestones **Foundation**, **Сканер**, **OCR срока** и **Уведомления**
> завершены — приложение собирается, устанавливается и работает офлайн; сканирование
> кодов, поиск товара по штрихкоду, распознавание срока по фото и напоминания о сроках
> реализованы. Список покупок и аналитика запланированы следующими итерациями
...
- Сканер/OCR/уведомления/список покупок/аналитика/бэкап — заглушки-«coming soon» или
  задел на уровне интерфейсов; это осознанные границы Foundation (не мёртвые кнопки).
- Экспорт/импорт данных ещё не реализован.
