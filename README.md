...
> **Статус:** milestones **Foundation**, **Сканер**, **OCR срока**, **Уведомления** и
> **Список покупок** завершены — приложение собирается, устанавливается и работает
> офлайн. Аналитика и экспорт/импорт запланированы следующими итерациями
