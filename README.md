...
> **Статус:** milestones **Foundation**, **Сканер** и **OCR срока** завершены —
> приложение собирается, устанавливается и работает офлайн; сканирование кодов, поиск
> товара по штрихкоду и распознавание срока годности по фото реализованы. Уведомления,
> список покупок и аналитика запланированы следующими итерациями
