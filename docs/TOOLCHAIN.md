...
| `androidx.lifecycle` 2.11.0 | **нельзя**, та же причина |
...
Оба потолка с 06.09.2026 закрыты блокировками в `.github/dependabot.yml`: без них
Dependabot приносил один и тот же заведомо красный PR каждую неделю.
